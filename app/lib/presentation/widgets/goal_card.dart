...
///
/// When [useGlassEffect] is true (e.g., on HomeScreen), the card applies
/// a glass-morphism effect with BackdropFilter while maintaining the gradient colors
class GoalCard extends StatelessWidget {
          ...
          child: Opacity(
            ...
            child: InkWell(
              ...
              child: useGlassEffect
                  ? _buildGlassCard(gradient)
                  : _buildStandardCard(gradient),
            ),
          ),
        );
      },
  ...
  /// Builds a standard card without glass effect (used in other screens)
  Widget _buildStandardCard(LinearGradient gradient) {
    return Container(
  ...
  /// Builds a water-like transparent glass card (used in HomeScreen)
  /// Creates a crystal clear water droplet effect with:
  /// - Nearly invisible transparent background
  /// - Vibrant neon-style colored border (just the border!)
  /// - Barely visible color tint (like water)
  Widget _buildGlassCard(LinearGradient gradient) {
    return ClipRRect(
      borderRadius: BorderRadius.circular(20),
      child: BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            // Thin, subtle border with goal color
            border: Border.all(
              width: 1.5,
              color: Color.lerp(
            ...
            boxShadow: [
              ...
              BoxShadow(
                ...
                spreadRadius: -5, // Negative spread keeps glow outside
              ),
            ],
          ),
          child: Padding(
  ...
  /// Builds the card content (shared between glass and standard cards)
